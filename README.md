<<<<<<< HEAD
# Mini-ML-Library Gruppennummer 854
...
```
cd existing_repo
git remote add origin https://gitlab.ub.uni-giessen.de/J_J9P7V7D/mini-ml-library-gruppennummer-854.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ub.uni-giessen.de/J_J9P7V7D/mini-ml-library-gruppennummer-854/-/settings/integrations)
